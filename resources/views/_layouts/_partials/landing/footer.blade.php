<footer class="w-full p-4 bg-white border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-900 dark:border-gray-600">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-gray-400 uppercase">Contacto</h2>
                <a href="#"
                    class="text-gray-500 font-sans font-semibold hover:text-blue-600">ever-green-paper@hotmail.com</a>
            </div>
            <div class="grid grid-cols-2 gap-8">
                ...
                <div>
                    <h2 class="mb-6 text-sm font-semibold text-gray-900 dark:text-gray-400 uppercase">Politicas de
                        reembolso</h2>
                    <ul class="text-gray-500 dark:text-gray-500">
                        <li class="mb-4">
